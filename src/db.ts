...
export function recordProgress(vocabId?: number) {
  db.runSync('INSERT INTO progress_event (vocab_id, created_at) VALUES (?, ?)', vocabId ?? null, new Date().toISOString());
}
